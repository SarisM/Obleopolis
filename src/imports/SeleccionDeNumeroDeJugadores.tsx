  ...
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[2px] items-start left-[166px] not-italic top-[calc(50%+0.5px)]">
      <p className="font-['Jetsy_Trial:Regular',sans-serif] leading-[0] relative shrink-0 text-[#fb58a7] text-[0px] w-[172px]">
        <span className="font-['Mochiy_Pop_P_One:Regular',sans-serif] leading-[normal] text-[22px]">2</span>
      ...
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] relative shrink-0 text-[15px] text-white w-[158px]">Duelo Dulce</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="bg-[#f4b5de] h-[136px] overflow-clip relative rounded-[10px] shadow-[0px_4px_4px_0px_rgba(77,61,18,0.1)] shrink-0 w-full">
  ...
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[2px] items-start left-[166px] not-italic top-[calc(50%+0.5px)]">
      <p className="font-['Jetsy_Trial:Regular',sans-serif] leading-[0] relative shrink-0 text-[#fb58a7] text-[25px] w-[172px]">
        <span className="font-['Mochiy_Pop_One:Regular',sans-serif] leading-[normal]">{`3 `}</span>
        <span className="leading-[normal]">cocineros</span>
      </p>
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] relative shrink-0 text-[15px] text-white w-[158px]">Triángulo Azucarado</p>
    </div>
  );
}
...
function Frame3() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col gap-[2px] items-start left-[166px] not-italic top-[calc(50%+0.5px)]">
      <p className="font-['Jetsy_Trial:Regular',sans-serif] leading-[0] relative shrink-0 text-[#fb58a7] text-[25px] w-[172px]">
        <span className="font-['Mochiy_Pop_One:Regular',sans-serif] leading-[normal]">{`4 `}</span>
        <span className="leading-[normal]">cocineros</span>
      </p>
      <p className="font-['Poppins:Medium',sans-serif] leading-[normal] relative shrink-0 text-[15px] text-white w-[158px]">Caos en la cocina</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="bg-[#f4b5de] h-[136px] overflow-clip relative rounded-[10px] shadow-[0px_4px_4px_0px_rgba(112,86,13,0.1)] shrink-0 w-full">
      <Group2 />
      <Frame3 />
...
export default function SeleccionDeNumeroDeJugadores() {
  return (
    <div className="bg-[#fffaee] relative size-full" data-name="Selección de Número de Jugadores">
      <Group />
      <Frame />
      <Frame8 />
      <Frame9 />
